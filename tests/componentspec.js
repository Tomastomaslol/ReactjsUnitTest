...
describe("component tests", function () {
    ...
    describe("component className", function () {
        ...
        beforeEach(function () {
            ...
            componets = TestUtils.scryRenderedDOMComponentsWithClass(mountedComponent,
                mountedComponent.props.className);
        });
    ...
    describe("functional click test", function () {
        ...
        it("should change innerHtml on onClick ref=p", function () {
        ...
        it("should change innerHtml on onClick ref=p and bubble event", function () {
            var onClickSpy = jasmine.createSpy('onClickSpy');
        ...
        it("should change className when clicked", function () {
            var componets;
